...
function Landing() {
  return (
    <div className="flex flex-col">
      <main className="flex-grow flex items-center justify-center overflow-hidden position-relative">
        ...
        <div className="w-full max-w-4xl text-white px-8 py-24 mx-auto z-0">
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full md:w-1/3 px-2 mb-4 md:mb-8">
              <div className="transition duration-500 ease-in-out hover:bg-white hover:text-black shadow-md rounded-lg p-6">
                <h3 className="text-2xl tracking-tight text-green-900 font-bold ml-0 mb-2">
            ...
            <div className="w-full md:w-1/3 px-4 mb-4 md:mb-8">
              <div className="transition duration-500 ease-in-out hover:bg-white hover:text-black shadow-md rounded-lg p-6">
                <h3 className="text-2xl tracking-tight text-green-900 font-bold mb-2">
